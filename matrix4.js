...
export function fromQuaternion( q ) {
	...
	return new Float32Array( [
		1 - ( q[ 1 ] * ( q[ 1 ] + q[ 1 ] ) ) - ( q[ 2 ] * ( q[ 2 ] + q[ 2 ] ) ), ( q[ 1 ] * ( q[ 0 ] + q[ 0 ] ) ) + ( q[ 3 ] * ( q[ 2 ] + q[ 2 ] ) ), ( q[ 2 ] * ( q[ 0 ] + q[ 0 ] ) ) - ( q[ 3 ] * ( q[ 1 ] + q[ 1 ] ) ), 0,
		( q[ 1 ] * ( q[ 0 ] + q[ 0 ] ) ) - ( q[ 3 ] * ( q[ 2 ] + q[ 2 ] ) ), 1 - ( q[ 0 ] * ( q[ 0 ] + q[ 0 ] ) ) - ( q[ 2 ] * ( q[ 2 ] + q[ 2 ] ) ), ( q[ 2 ] * ( q[ 1 ] + q[ 1 ] ) ) + ( q[ 3 ] * ( q[ 0 ] + q[ 0 ] ) ), 0,
		( q[ 2 ] * ( q[ 0 ] + q[ 0 ] ) ) + ( q[ 3 ] * ( q[ 1 ] + q[ 1 ] ) ), ( q[ 2 ] * ( q[ 1 ] + q[ 1 ] ) ) - ( q[ 3 ] * ( q[ 0 ] + q[ 0 ] ) ), 1 - ( q[ 0 ] * ( q[ 0 ] + q[ 0 ] ) ) - ( q[ 1 ] * ( q[ 1 ] + q[ 1 ] ) ), 0,
		0, 0, 0, 1
	] )
}

export function applyToVector3( m4, v3 ) {
